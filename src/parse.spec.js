import calculateTaxonLine from './parse';
...
describe('the parser', () => {
    ...
    it('should be able to gather comments from a species line', () => {
        ...
        let count = calculateTaxonLine( line );
    ...
    it('should calculate male, female, and unspecified sex of recorded species', () => {
        ...
        let count = calculateTaxonLine( 'MALL 1 6 2m 3m mmm f m 3 4f fmfm' );
    ...
    it('should correctly calculate juveniles, immatures, and adults', () => {
        ...
        let count = calculateTaxonLine( 'YHVI m f 3j 2a 4i "three in nest, two out of nest"' );
    ...
    it('should handle an empty line', () => {
        ...
        let count = calculateTaxonLine('MALL');
    ...
    it('should handle combo counts', () => {
        ...
        let count = calculateTaxonLine( 'HOME 2am 3f 2m 3fa' );
    ...
    it('should parse invalid declarations as comments', () => {
        ...
        let count = calculateTaxonLine( 'BAEA 2ar 3i 4a lots of these here' );
    ...
    it('should be able to process custom taxon identifiers', () => {
        ...
        let count = calculateTaxonLine( '[finch sp.] 30 "flyovers"');
    ...
    it('should be able to process checks', () => {
        ...
        let count = calculateTaxonLine( 'PIWA x "new nesting cavity"');
    ...
    it('should be able to handle a blank species identifier', () => {
        ...
        let count = calculateTaxonLine( '[] 35 "flyover of unknown passerine"' );
    ...
    it('should many specs at once', () => {
        ...
        let count = calculateTaxonLine( 'MALL 27m 10f 15am 20if many feeding at pond 100 "courting behaviour observed" 55 10i' )
    ...
    it('should reject juvenile-sex specifications', () => {
        ...
        let count = calculateTaxonLine('RHWO 2jm 4');
